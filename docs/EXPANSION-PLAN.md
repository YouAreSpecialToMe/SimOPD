...
(f1/f2/f3)+ b1;m3 = G 门(g1/g2)+ h1 + e1——12 臂 ×3 = 36 run;**每机 3 泳道(MAX_LANES 档案),一轮恰好一个臂的三 seed 同发**
(08-08 裁定),4 轮 ≈ 2.5-4.5 天;每机余下一对卡 = 锚/离线 suite 评测备用道。**vanilla 移远程池**(用户裁定"协同者跑 vanilla 我们跑臂"):判决配对
