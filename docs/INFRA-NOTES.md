...
新日志只记 51 步往后,于是 1–50 整段被丢掉:**8 条 (arm,seed) 曲线共 355 个 step 行**
(b4_jsd_b0.1 s0/s1 60→13、59→13;b4_jsd_b0.9 s0/s1 57→16、59→15;f2_clip2.3 s0/s2
51→11、50→11;h4_random_scatter s0/s1 61→12、61→12),in-loop 表里 s25/s50 两列从三 seed
退成 `·1`,而表面上一切正常 —— 最大 step 还涨了。
