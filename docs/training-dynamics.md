...
| file | rows | what |
|---|---|---|
| [`data/training_metrics_16k_per25.csv`](data/training_metrics_16k_per25.csv) | 834 | per **seed**, at each 25-step checkpoint — lines up 1:1 with the saved checkpoints and their offline evals. Browsable on GitHub. |
| [`data/training_metrics_16k_full.csv.gz`](data/training_metrics_16k_full.csv.gz) | 21114 | per **seed**, at **every** training step, all 43 metrics. 2.2 MB gzipped. |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| `a2_coldstart` | 13102 | 16338 | 16384 | 16384 | 16345 | 16384 | 16384 | 16384 | 16384 | – | `▇████████ ` |
...
| `g5_rgopd_gate` | 1941 | 12717 | 9846 | 10544 | 15473 | 16384 | 16384 | – | – | – | `▁▇▅▅███   ` |
| `h2_last_segment` | 7242 | 16229 | 16353 | 16352 | 16351 | 16343 | 16384 | 16363 | 16384 | – | `▄████████ ` |
...
| `e2_set_coverage` | 1732 | 13900 | 12802 | 12031 | 15078 | 16267 | 16214 | – | – | – | `▁▇▇▆███   ` |
...
| arm | 25 | 50 | 75 | 100 | 125 | 150 | 175 | 200 | 225 | 250 | trend |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `a2_coldstart` | 0.599 | 0.992 | 1.000 | 1.000 | 0.997 | 1.000 | 1.000 | 1.000 | 1.000 | – | `▅████████ ` |
...
| `g5_rgopd_gate` | 0.010 | 0.674 | 0.227 | 0.229 | 0.875 | 1.000 | 1.000 | – | – | – | `▁▆▂▂▇██   ` |
| `h2_last_segment` | 0.268 | 0.984 | 0.995 | 0.997 | 0.997 | 0.997 | 1.000 | 0.997 | 1.000 | – | `▃████████ ` |
...
| `e2_set_coverage` | 0.008 | 0.771 | 0.643 | 0.482 | 0.820 | 0.987 | 0.979 | – | – | – | `▁▇▆▄▇██   ` |
...
| arm | 25 | 50 | 75 | 100 | 125 | 150 | 175 | 200 | 225 | 250 | trend |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `a2_coldstart` | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | – | `█████████ ` |
...
| `e2_set_coverage` | 14273 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | – | – | – | `▅██████   ` |
...
| `g5_rgopd_gate` | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | – | – | – | `███████   ` |
| `h1_first_segment` | 11655 | 15580 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | `▁▇████████` |
| `h2_last_segment` | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | 16384 | – | `█████████ ` |
...
| `a2_coldstart` | 0.458 | 0.233 | 0.223 | 0.233 | 0.231 | 0.233 | 0.232 | 0.227 | 0.237 | – | `▁▁▁▁▁▁▁▁▁ ` |
| `g5_rgopd_gate` | 0.435 | 0.141 | 0.279 | 0.308 | 0.252 | 0.225 | 0.235 | – | – | – | `▁▁▁▁▁▁▁   ` |
...
| `e2_set_coverage` | 0.274 | 0.092 | 0.150 | 0.201 | 0.194 | 0.196 | 0.191 | – | – | – | `▁▁▁▁▁▁▁   ` |
| `h2_last_segment` | 2.973 | 0.920 | 0.322 | 0.341 | 0.316 | 0.276 | 0.204 | 0.191 | 0.188 | – | `▄▁▁▁▁▁▁▁▁ ` |
...
| `h2_last_segment` | 9.853 | 4.403 | 2.950 | 3.238 | 2.718 | 2.325 | 1.410 | 1.223 | 1.341 | – | `▅▂▂▂▂▁▁▁▁ ` |
...
| `g5_rgopd_gate` | 3.758 | 1.412 | 1.358 | 1.073 | 0.845 | 0.602 | 0.612 | – | – | – | `▂▁▁▁▁▁▁   ` |
...
| `a2_coldstart` | 2.378 | 0.753 | 0.611 | 0.553 | 0.572 | 0.547 | 0.539 | 0.552 | 0.551 | – | `▁▁▁▁▁▁▁▁▁ ` |
...
| `e2_set_coverage` | 0.587 | 0.132 | 0.105 | 0.100 | 0.078 | 0.061 | 0.051 | – | – | – | `▁▁▁▁▁▁▁   ` |
...
| `a2_coldstart` | 0.112 | 0.102 | 0.089 | 0.076 | 0.073 | 0.081 | 0.120 | 0.104 | 0.102 | – | `▇▆▅▅▅▅▇▆▆ ` |
...
| `e2_set_coverage` | 0.052 | 0.055 | 0.065 | 0.083 | 0.096 | 0.076 | 0.091 | – | – | – | `▃▄▄▅▆▅▆   ` |
...
| `g5_rgopd_gate` | 0.068 | 0.062 | 0.089 | 0.089 | 0.076 | 0.104 | 0.062 | – | – | – | `▄▄▅▅▅▆▄   ` |
...
| `h2_last_segment` | 0.047 | 0.016 | 0.016 | 0.010 | 0.016 | 0.018 | 0.034 | 0.057 | 0.026 | – | `▃▁▁▁▁▂▂▄▂ ` |
...
| `g5_rgopd_gate` | 0.4505 | 0.2683 | 0.4572 | 0.4449 | 0.3639 | 0.2673 | 0.2849 | – | – | – | `▃▃▃▃▃▃▃   ` |
| `f2_hard_clip` | 0.4569 | 0.2651 | 0.4474 | 0.4607 | 0.4451 | 0.4394 | 0.4304 | 0.2881 | 0.2796 | 0.2739 | `▃▃▃▃▃▃▃▃▃▃` |
| `a2_coldstart` | 0.4204 | 0.2965 | 0.2802 | 0.2777 | 0.2665 | 0.2641 | 0.2582 | 0.2507 | 0.2672 | – | `▃▃▃▃▃▃▃▃▃ ` |
...
| `e2_set_coverage` | 0.0592 | 0.0222 | 0.0289 | 0.0374 | 0.0351 | 0.0333 | 0.0312 | – | – | – | `▂▂▂▂▂▂▂   ` |
| `h2_last_segment` | 0.4070 | 0.1692 | 0.0882 | 0.1180 | 0.0941 | 0.0648 | 0.0302 | 0.0201 | 0.0244 | – | `▃▃▂▂▂▂▂▂▂ ` |
...
### 5.2 Student mass on the teacher's top-k

| arm | 25 | 50 | 75 | 100 | 125 | 150 | 175 | 200 | 225 | 250 | trend |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `b3_eopd_gate` | 0.8957 | 0.9802 | 0.9839 | 0.9991 | 0.9999 | 0.9998 | 0.9997 | 0.9996 | 0.9997 | 0.9997 | `▇█████████` |
| `e2_set_coverage` | 0.9903 | 0.9983 | 0.9982 | 0.9980 | 0.9981 | 0.9982 | 0.9984 | – | – | – | `███████   ` |
...
| `g5_rgopd_gate` | 0.534 | 0.309 | 0.546 | 0.538 | 0.438 | 0.330 | 0.355 | – | – | – | `▂▁▂▂▂▁▁   ` |
| `f2_hard_clip` | 0.572 | 0.314 | 0.552 | 0.579 | 0.564 | 0.563 | 0.552 | 0.364 | 0.358 | 0.350 | `▂▁▂▂▂▂▂▁▁▁` |
| `a2_coldstart` | 0.534 | 0.375 | 0.354 | 0.352 | 0.338 | 0.336 | 0.329 | 0.322 | 0.343 | – | `▂▁▁▁▁▁▁▁▁ ` |
...
| `h2_last_segment` | 0.629 | 0.274 | 0.135 | 0.175 | 0.140 | 0.103 | 0.042 | 0.028 | 0.037 | – | `▂▁▁▁▁▁▁▁▁ ` |
| `b3_eopd_gate` | 0.812 | 0.704 | 0.791 | 0.202 | 0.030 | 0.033 | 0.047 | 0.051 | 0.049 | 0.033 | `▃▂▃▁▁▁▁▁▁▁` |

## 6. Cost

### 6.1 Seconds per training step

![seconds per step](img/dyn-step-time.svg)

| arm | 25 | 50 | 75 | 100 | 125 | 150 | 175 | 200 | 225 | 250 | trend |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `e2_set_coverage` | 119 | 940 | 829 | 766 | 1002 | 1111 | 1120 | – | – | – | `▁▇▆▆███   ` |
| `h2_last_segment` | 431 | 1041 | 1051 | 1049 | 1059 | 1051 | 1051 | 1059 | 1061 | – | `▃████████ ` |
| `a2_coldstart` | 795 | 1059 | 1058 | 1061 | 1051 | 1051 | 1060 | 1063 | 1056 | – | `▆████████ ` |
| `g5_rgopd_gate` | 126 | 792 | 525 | 562 | 975 | 1052 | 1052 | – | – | – | `▁▆▄▄▇██   ` |
...
### 6.2 Generation time per step (seconds)

| arm | 25 | 50 | 75 | 100 | 125 | 150 | 175 | 200 | 225 | 250 | trend |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `e2_set_coverage` | 65 | 736 | 632 | 576 | 777 | 869 | 864 | – | – | – | `▁▇▆▆███   ` |
| `h2_last_segment` | 319 | 825 | 833 | 832 | 839 | 832 | 834 | 834 | 836 | – | `▃████████ ` |
| `a2_coldstart` | 614 | 836 | 832 | 832 | 830 | 831 | 832 | 832 | 831 | – | `▆████████ ` |
| `g5_rgopd_gate` | 72 | 617 | 386 | 418 | 769 | 830 | 830 | – | – | – | `▁▆▄▄███   ` |
...
|---|---|---|---|---|---|
| `actor/distillation/abs_loss` | 28 | 0.5343 | 0.3674 | 0.03342 | 2.535 |
| `actor/distillation/delta_ell_p5` | 20 | -2.941 | -2.059 | -6.971 | -0.03917 |
| `actor/distillation/delta_ell_p95` | 20 | 0.3243 | 0.1609 | 0.06357 | 1.523 |
| `actor/distillation/entropy_gap_abs` | 13 | 0.916 | 0.2321 | 0.0112 | 3.929 |
| `actor/distillation/entropy_student` | 13 | 1.479 | 0.5079 | 0.001229 | 5.338 |
| `actor/distillation/entropy_teacher_topk` | 13 | 0.6168 | 0.4626 | 0.01173 | 1.415 |
| `actor/distillation/overlap_student_mass` | 13 | 0.8853 | 0.9942 | 0.5401 | 0.9997 |
| `actor/distillation/overlap_teacher_mass` | 13 | 0.9029 | 0.9924 | 0.6638 | 0.9979 |
| `actor/distillation/overlap_token_advantage` | 13 | -0.0198 | -0.01813 | -0.02825 | -0.01247 |
| `actor/distillation/pg_clipfrac` | 19 | 0 | 0 | 0 | 0 |
| `actor/distillation/ppo_kl` | 19 | 0 | 0 | 0 | 0 |
| `actor/distillation/rank_kendall_tau` | 10 | 0.4343 | 0.4863 | 0.3663 | 0.4942 |
| `actor/distillation/teacher_mass` | 13 | 0.92 | 0.9986 | 0.695 | 0.9999 |
| `actor/loss` | 29 | 0.4185 | 0.2695 | -0.1712 | 2.196 |
| `actor/pg_clipfrac` | 20 | 0 | 0 | 0 | 0 |
| `actor/pg_clipfrac_lower` | 20 | 0 | 0 | 0 | 0 |
| `actor/pg_loss` | 20 | -0.03273 | -0.06997 | -0.09879 | 0.03166 |
| `actor/ppo_kl` | 20 | 0 | 0 | 0 | 0 |
| `critic/advantages/mean` | 29 | 0.02802 | 0.07689 | -0.03166 | 0.1084 |
| `critic/rewards/mean` | 29 | 0.05208 | 0.08854 | 0 | 0.1276 |
| `response/aborted_ratio` | 29 | 0 | 0 | 0 | 0 |
| `rollout_corr/chi2_seq` | 29 | 2.802 | 0.2016 | -1 | 196.6 |
| `rollout_corr/chi2_token` | 29 | 0.001693 | 0.001713 | 0.0006132 | 0.003794 |
| `rollout_corr/k3_kl` | 29 | 0.0008305 | 0.0008446 | 0.0002843 | 0.001899 |
| `rollout_corr/kl` | 29 | 0.0008734 | 0.0008427 | 0.0002656 | 0.001913 |
| `rollout_corr/ppl_ratio` | 29 | 1.001 | 1.001 | 1 | 1.002 |
| `rollout_corr/rollout_ppl` | 29 | 34.52 | 1.318 | 1.001 | 258.4 |
| `rollout_corr/training_ppl` | 29 | 35.15 | 1.319 | 1.001 | 258.9 |
| `training/rollout_actor_probs_pearson_corr` | 29 | 0.9995 | 0.9986 | 0.9841 | 0.9997 |
| `training/rollout_probs_diff_max` | 29 | 0.2552 | 0.5203 | 0.1839 | 0.763 |
| `training/rollout_probs_diff_mean` | 29 | 0.003522 | 0.004167 | 0.0001143 | 0.009524 |
